...
Error: object 'mean_growth' not found
...
NOTE: These projections assume constant growth rate (%.2f ppm/year).
 2.783333> Actual trajectory depends on emission policies and carbon sink dynamics.
...
#cat(sprintf("Projected 2050 (BAU):   %.0f ppm\n", projected_2050)))
#+END_SRC
...
: Error: object 'recent_growth' not found
: Model fit:              R² = 0.9751
